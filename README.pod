...
=for html
You can download Filesys::SamFS from <A HREF="http://www.cpan.org/">CPAN</A> and from <A HREF="http://free.prohosting.com/~lupe/Personal/Perl/Filesys-SamFS-0.021.tar.gz">my website</A>.
...
Tested with versions 3.3.0-40 and 3.3.1-15.
...
=for html
Filesys::SamFS has it's own <A HREF="http://free.prohosting.com/~lupe/Personal/Perl/Filesys-SamFS/">webpage</A>.

=begin text

    Filesys::SamFS has it's own webpage at
    http://free.prohosting.com/~lupe/Personal/Perl/Filesys-SamFS/ .
