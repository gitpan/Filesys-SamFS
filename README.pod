...
Copyright (c) 2000,2001 Lupe Christoph. All rights reserved.

=head2 License

This software is covered by Perl's Artistic license, see the
file Artistic included in the distribution.
...
=for html
Filesys::SamFS has it's own <A HREF="http://www.lupe-christoph.de/Personal/Perl/Filesys-SamFS/">webpage</A>.
